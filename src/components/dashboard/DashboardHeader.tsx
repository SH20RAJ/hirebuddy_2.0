...
export function DashboardHeader({ userName, isNewSession = false }: DashboardHeaderProps) {
  ...
  return (
    <div className="pb-8">
      {/* Welcome Section */}
      <div className={`mb-8 p-6 rounded-xl border ${isPremium
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Button asChild variant="outline" size="sm" className={`bg-white/80 ${isPremium
            ...
            <Button asChild size="sm" className={`${isPremium
        ...
        {/* Quick Tips */}
        <div className={`mt-4 flex items-center gap-2 text-sm bg-white/60 p-3 rounded-lg border ${isPremium ? "border-gray-200" : "border-pink-200"
          }`}>
          {isPremium ? (
