            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">sharmanishant9119@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+91 9119911991pushh</p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Tower 2, Apartment 404, M3M Merlin<br />
                    Golf Course Road Extn., Sector 67<br />
                    Gurugram, India
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">For urgent matters, email us directly</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                You can reach out to us via email at sharmanishant9119@gmail.com or call us during 
                business hours. We also have a live chat feature on our website.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                ...
                email subject, and we'll schedule a convenient time for you.
              </p>
            </div>
          </div>
        </div>
